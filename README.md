...
**SENSAAS** is a shape-based alignment program to superimpose molecules as described in the publication <a href="https://onlinelibrary.wiley.com/doi/full/10.1002/minf.202000081" target="_blank">SenSaaS: Shape-based Alignment by Registration of Colored Point-based Surfaces</a> ( https://doi.org/10.1002/minf.202000081)
