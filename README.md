...
**Website**: A web demo to use SENSAAS or [SENSAAS-Flex](https://github.com/SENSAAS/sensaas-flex) is available at https://chemoinfo.ipmc.cnrs.fr/SENSAAS/index.html
