...
#executes ./<>.py matrix-sensaas.txt catsensaas.sdf  
#creates ordered-catsensaas.sdf and ordered-score.txt
...
try:
    ...
    print('usage: ordered-catsensaas.py matrix-sensaas.txt catsensaas.sdf ')
    quit()
