...
#WORKS ONLY "in place", i.e., without realigning poses. 
# atoms may not appear in the same order 
...
def CalcLigRMSD(lig1, lig2, rename_lig2 = False, output_filename="rename.pdb"):
    """
...
m1 = Chem.SDMolSupplier(mol1,removeHs=True)
m2 = Chem.SDMolSupplier(mol2,removeHs=True)

for molecule1 in m1:
    for molecule2 in m2:
        rmsd=CalcLigRMSD(molecule1,molecule2)
