...
#executes ./<>.py matrix-sensaas.txt catsensaas.sdf 1.4
#creates ordered-catsensaas.sdf and ordered-score.txt only with solutions having gfit+hfit >= 1.4
...
try:
    ...
    print('usage: ordered-catsensaas.py matrix-sensaas.txt catsensaas.sdf 1.4 ')
    quit()
