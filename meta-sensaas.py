...
#######################################
#def randomizesdf(inputfile,outputfile=tmpsre.sdf)


#######################################
#ordered matrix-sensaas.txt into sensaas-score.txt (# i j gfit+hfit score per line ordered) and ordered-catsensaas.sdf
    ...
    while (ri <= repeat):
        ...
        while(i < nbt):
            ...
            while(j < nbs):
                ...
                #re-orientation using def randomizesdf(inputfile,outputfile=tmpsre.sdf)
...
#Database mode:
    ...
    #def ordered matrix-sensaas.txt into sensaas-score.txt (# i j gfit+hfit score per line ordered) and ordered-catsensaas.sdf
    #here
