...
This software is the result of a collaboration between researchers of two labs of University Côte d'Azur <https://www.i3s.unice.fr/>: I3S <https://www.i3s.unice.fr/>`_ and `IPMC <https://www.ipmc.cnrs.fr/cgi-bin/site.cgi>`_. 
